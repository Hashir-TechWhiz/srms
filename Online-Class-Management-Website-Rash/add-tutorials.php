...
if(strlen($_SESSION['alogin'])=="") {   
    ...
    if(isset($_POST['submit'])) {
        ...
        $rename_pdf = uniqid().'.'.$pdf_ext;
        $pdf_tmp_name = $_FILES['pdf']['tmp_name'];
        $pdf_folder = 'uploaded_files/'.$rename_pdf;

        move_uploaded_file($pdf_tmp_name, $pdf_folder);

        $sql = "INSERT INTO tutorials(ClassId, SubjectId, title, pdf, description, teacher_id) 
                VALUES(:class, :subject, :title, :pdf, :description, :teacherid)";
        
        $query = $dbh->prepare($sql);
        $query->bindParam(':title', $title, PDO::PARAM_STR);
        $query->bindParam(':pdf',$rename_pdf, PDO::PARAM_STR);
...
<head>
    ...
    <title>SRMS Admin Add Tutorial</title>
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Add Tutorial</h2>
                            </div>
                        </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="title" class="form-control" id="default" placeholder="Tutorial Title" required="required">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="default" class="col-sm-2 control-label">Description</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="description" class="form-control" id="default" placeholder="Tutorial Description" required="required">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="default" class="col-sm-2 control-label">PDF File</label>
                                                <div class="col-sm-10">
