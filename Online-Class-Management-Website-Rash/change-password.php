...
$np=($_POST['np']);
$id=$_SESSION['id'];
    $sql ="SELECT password FROM student WHERE id=:id and password=:op";
...
{
$con="update student set Password=:newpassword where id=:id";
$chngpwd1 = $dbh->prepare($con);
$chngpwd1-> bindParam(':id', $id, PDO::PARAM_STR);
$chngpwd1-> bindParam(':np', $np, PDO::PARAM_STR);
$chngpwd1->execute();
